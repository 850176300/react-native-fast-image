...
Pod::Spec.new do |s|
  ...
  s.homepage = "https://github.com/850176300/react-native-fast-image#readme"
  s.license = "MIT"
  ...
  s.source = { :git => "https://github.com/850176300/react-native-fast-image.git", :tag => "v"+package['version'] }
